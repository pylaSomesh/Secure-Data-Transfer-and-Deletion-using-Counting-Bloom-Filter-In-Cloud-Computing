...
<head>
    ...
    <title>Get VMR - Cloud Resources</title>
        ...
        <div class="col-md-8">
            <div class="custom-card">
                <form id="form1" name="form1" method="post" action="EditDetails.jsp">
                    <div class="mb-4">
                        <label class="form-label fw-medium">Cloud Name</label>
                    ...
                    <div class="mb-4">
                        <label class="form-label fw-medium">VM Memory</label>
                        <select id="s1" name="vmm" class="form-select">
        ...
        <div class="col-md-10">
            <div class="custom-card">
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Cloud Cost in ₹</th>
                ...
                <div class="text-center mt-4">
                    <a href="CloudServerMain.jsp" class="btn btn-outline-primary">
