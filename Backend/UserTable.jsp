...
<head>
  ...
  <title>Cloud Details - Secure Data Transfer</title>
...
<div class="container py-5">
  <div class="text-center mb-4">
    <h2 class="fw-bold text-primary">Cloud Details</h2>
    <p class="text-muted">View and manage your cloud storage information</p>
  </div>
