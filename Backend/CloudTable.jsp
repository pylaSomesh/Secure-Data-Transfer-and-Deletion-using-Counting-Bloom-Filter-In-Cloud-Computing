...
<head>
    ...
    <title>Cloud Files - Secure Data Transfer</title>
...
<div class="container py-5">
    <div class="text-center mb-4">
        <h2 class="fw-bold" style="color: #4a00e0;">
            <i class="bi bi-cloud-fill me-2"></i>Cloud Files Details
        </h2>
        <p class="text-muted">View and manage your cloud storage files</p>
    </div>
