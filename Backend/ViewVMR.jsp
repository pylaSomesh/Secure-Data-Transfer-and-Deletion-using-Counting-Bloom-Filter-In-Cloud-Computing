  ...
  <div class="row justify-content-center">
    <div class="col-lg-10">
      <div class="custom-card">
        <h2 class="text-center mb-4">View VM Resources</h2>
        
        <!-- VM Resource Selection Form -->
        <form id="form1" name="form1" method="post" action="ViewVMR.jsp" class="mb-5">
          <div class="row justify-content-center">
            <div class="col-md-8">
              <div class="mb-4">
                <label for="s1" class="form-label fw-bold">Select Cloud Server</label>
                <select id="s1" name="cloudn" class="form-select">
              ...
              <div class="text-center">
                <button type="submit" name="Submit" class="btn btn-primary">
                  <i class="bi bi-cloud-download me-2"></i>Get Resources
                </button>
              </div>
            </div>
          </div>
        ...
        <!-- VM Resource Details Table -->
        <div class="table-responsive mt-5">
          <h3 class="text-center mb-4">VM Resource & Price Details</h3>
        ...
        <div class="text-center mt-4">
          <a href="ProxyServerMain.jsp" class="btn btn-outline-primary">
            <i class="bi bi-arrow-left me-2"></i>Back to Proxy Server
          </a>
        </div>
      </div>
    </div>
